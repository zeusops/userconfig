ocap_minPlayerCount = 5; // recording will only begin if this many players are in the server
ocap_minMissionTime = 30; // missions must last at least this many minutes to be saved
