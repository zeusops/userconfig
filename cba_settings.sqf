...
force force ABS_enableManualUnflip = true;
...
force force boxloader_hidecargo_enabled = false;
...
diwako_dui_radar_namelist_vertical_spacing = 0.994475;
...
force force tsp_cba_breach_lock_door = 0.75;
